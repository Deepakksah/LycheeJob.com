...
const FALLBACK_JOBS: Job[] = [
  ...
  // --- EXPANDED ALL INDIA TECH JOBS (50+ DATASET) ---
  {
    ...
    companyId: 18,
    company: { id: 18, name: 'Tata Consultancy Services (TCS)', industry: 'IT & Consulting' },
  ...
  },
  {
    ...
    companyId: 19,
    company: { id: 19, name: 'Infosys', industry: 'IT Services' },
  ...
  },
  {
    ...
    companyId: 20,
    company: { id: 20, name: 'Wipro', industry: 'IT & Outsourcing' },
  ...
  },
  {
    ...
    companyId: 21,
    company: { id: 21, name: 'Zomato', industry: 'FoodTech & Logistics' },
  ...
  },
  {
    ...
    companyId: 22,
    company: { id: 22, name: 'Swiggy', industry: 'Consumer Tech' },
  ...
  },
  {
    ...
    companyId: 23,
    company: { id: 23, name: 'Paytm', industry: 'FinTech' },
  ...
  },
  {
    ...
    companyId: 24,
    company: { id: 24, name: 'Flipkart', industry: 'E-Commerce' },
  ...
  },
  {
    ...
    companyId: 25,
    company: { id: 25, name: 'Accenture', industry: 'IT & Consulting' },
  ...
  },
  {
    ...
    companyId: 26,
    company: { id: 26, name: 'Amazon', industry: 'Cloud & Retail' },
  ...
  },
  {
    ...
    companyId: 27,
    company: { id: 27, name: 'Uber', industry: 'Mobility & Tech' },
  ...
  },
  {
    ...
    companyId: 28,
    company: { id: 28, name: 'Cred', industry: 'FinTech' },
  ...
  },
  {
    ...
    companyId: 29,
    company: { id: 29, name: 'Razorpay', industry: 'FinTech Payment Infrastructure' },
  ...
  },
  {
    ...
    companyId: 30,
    company: { id: 30, name: 'Adobe', industry: 'Creative Software & Cloud' },
